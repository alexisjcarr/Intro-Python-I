...
you omit either the year or both values, it should use today’s date to get the
month and year.
"""
...
def main(args):
    try:
        ...
        if num_args == 0:
            ...
            year = datetime.now().year
            month = args[1]
            return calendar.month(year, int(month))
        else:
            return "Format of program needs to be 14_cal.py [month] [year]"
